...
# 总结各activity的子任务列表
 # 将所有的uix文件改为xml文件
folder_path = "..\\app\\translate_activity\\activity"
...
with open("..\\app\\translate_activity\\activity_task.json", 'w') as file1:
    json.dump(activity_task, file1, indent=4, separators=(',', ': '))
with open("..\\app\\translate_activity\\state_widgets.json", 'w') as file2:
    json.dump(state_widgets, file2, indent=4, separators=(',', ': '))
with open("..\\app\\translate_activity\\page_html.json",'w') as file3:
    json.dump(page_htmls, file3, indent=4, separators=(',', ': '))
with open("..\\app\\translate_activity\\state_task.json",'w') as file4:
    json.dump(state_task, file4, indent=4, separators=(',', ': '))

# 总结应用各页面的功能
 # 总结各个activity的功能
with open("..\\app\\translate_activity\\activity_task.json", 'r') as file1:
    ...
    with open("..\\app\\translate_activity\\activity_function.json", 'w') as file2:
